...
unit package WebKit::Raw::Settings;
...
sub webkit_settings_get_all_features
...
sub webkit_settings_get_allow_top_navigation_to_data_urls (
  WebKitSettings $settings
)
  returns uint32
  is      native(webkit)
...
sub webkit_settings_get_development_features
  returns WebKitFeatureList
  is      native(webkit)
  is      export
{ * }

sub webkit_settings_get_disable_web_security (WebKitSettings $settings)
  returns uint32
  is      native(webkit)
  is      export
{ * }

sub webkit_settings_get_draw_compositing_indicators (WebKitSettings $settings)
  returns uint32
  is      native(webkit)
  is      export
{ * }

sub webkit_settings_get_enable_back_forward_navigation_gestures (
  WebKitSettings $settings
)
  returns uint32
  is      native(webkit)
...
sub webkit_settings_get_enable_javascript_markup (WebKitSettings $settings)
  returns uint32
  is      native(webkit)
  is      export
{ * }

sub webkit_settings_get_enable_media (WebKitSettings $settings)
  returns uint32
  is      native(webkit)
  is      export
{ * }
...
sub webkit_settings_get_enable_mock_capture_devices (WebKitSettings $settings)
  returns uint32
  is      native(webkit)
  is      export
{ * }
...
sub webkit_settings_get_enable_site_specific_quirks (WebKitSettings $settings)
  returns uint32
  is      native(webkit)
  is      export
{ * }
...
sub webkit_settings_get_enable_webrtc (WebKitSettings $settings)
  returns uint32
  is      native(webkit)
  is      export
{ * }
...
sub webkit_settings_get_experimental_features
  returns WebKitFeatureList
  is      native(webkit)
  is      export
{ * }
...
sub webkit_settings_get_feature_enabled (
  WebKitSettings $settings,
...
sub webkit_settings_get_hardware_acceleration_policy (WebKitSettings $settings)
  returns WebKitHardwareAccelerationPolicy
  is      native(webkit)
  is      export
{ * }
...
sub webkit_settings_get_media_content_types_requiring_hardware_support (
  WebKitSettings $settings
)
  returns Str
  is      native(webkit)
...
sub webkit_settings_get_media_playback_allows_inline (WebKitSettings $settings)
  returns uint32
  is      native(webkit)
  is      export
{ * }
...
sub webkit_settings_set_allow_top_navigation_to_data_urls (
  WebKitSettings $settings,
  gboolean       $allowed
)
  is      native(webkit)
...
sub webkit_settings_set_disable_web_security (
  WebKitSettings $settings,
  gboolean       $disabled
)
  is      native(webkit)
...
sub webkit_settings_set_enable_back_forward_navigation_gestures (
  WebKitSettings $settings,
  gboolean       $enabled
)
  is      native(webkit)
...
sub webkit_settings_set_enable_javascript_markup (
  WebKitSettings $settings,
  gboolean       $enabled
)
  is      native(webkit)
...
sub webkit_settings_set_enable_media (
  WebKitSettings $settings,
  gboolean       $enabled
)
  is      native(webkit)
...
sub webkit_settings_set_enable_mock_capture_devices (
  WebKitSettings $settings,
  gboolean       $enabled
)
  is      native(webkit)
...
sub webkit_settings_set_enable_webrtc (
  WebKitSettings $settings,
  gboolean       $enabled
)
  is      native(webkit)
...
sub webkit_settings_set_feature_enabled (
  WebKitSettings $settings,
  WebKitFeature  $feature,
  gboolean       $enabled
)
...
sub webkit_settings_set_media_content_types_requiring_hardware_support (
  WebKitSettings $settings,
  Str            $content_types
)
  is      native(webkit)
